...
export declare function resolveConfig(mode: string, configPath?: string): Promise<ResolvedConfig>;
export declare function loadEnv(mode: string, root: string, prefix?: string): dotenv.DotenvParseOutput;
